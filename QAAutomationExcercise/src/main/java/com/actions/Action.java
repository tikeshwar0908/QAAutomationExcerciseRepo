...
//	public boolean selectBySendkeys(String value,WebElement element) {
	...
	public boolean enterTextValue(String value, WebElement element) {
		boolean flag = false;
		try {
...
//	}
	...
	public void clickVisibleElement(WebDriver driver, List<WebElement> elements, String elementName) {
	    ...
	    for (WebElement element : elements) {
	        ...
	        if (element.isDisplayed()) {
	            ...
	            try {
	                ...
	                System.out.println("Normal click failed. Trying JS click on: " + elementName);

	                ((JavascriptExecutor) driver)
	                        .executeScript("arguments[0].click();", element);
	            }

	            System.out.println("Clicked on visible element: " + elementName);

	            return;
	        }
	    }

	    throw new RuntimeException("No visible element found for: " + elementName);
	}
